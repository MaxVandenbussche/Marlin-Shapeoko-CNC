...
// #define RAMPS_V_1_0
  ...
  #else
    #define HEATER_0_PIN       -1   // EXTRUDER 1 (Max Vandenbussche:  No extruder for CNC router, pin used for other control, spindle eg.)
  #endif
  ...
  #if MOTHERBOARD == 33				// Max Vandenbussche: Added spindle-controll!
	#define SPINDLE_1_PIN		8  
	#define SPINDLE_2_PIN		10
  #endif
  ...
  #define TEMP_1_PIN         15   // ANALOG NUMBERING
    ...
    #else
      #define HEATER_BED_PIN     -1    // BED (Max Vandenbussche:  No heaterbed for CNC router, pin used for other control, spindle eg.)
      #endif
  #endif
